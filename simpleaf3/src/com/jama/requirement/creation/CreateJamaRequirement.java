package com.jama.requirement.creation;
...
public class CreateJamaRequirement {
	public void create_jama_reqq() {
		// TODO Auto-generated method stub
	String projectIDForJSON = "15";
		
		String reqIdentifier = "newRequirementX2012278686bla-----------------------";
		
		// create new requirement
		Requirement requirement = new Requirement();
	//	org.eclipse.lyo.client.oslc.resources.Requirement requirement=JamaRequirmentUtil.createJamaRequirement();
		System.out.println("Requirement instance is created");
...
//					String jamaInstanceName = "koneksys";
			...
			public static void main (String args[])
			{
				...
				String projectIDForJSON = "15";
					...
					String reqIdentifier = "newRequirementX20122786";
