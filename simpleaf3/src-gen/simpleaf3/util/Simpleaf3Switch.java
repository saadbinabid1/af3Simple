 ...
 * @generated
 */
public class Simpleaf3Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static Simpleaf3Package modelPackage;
	 ...
	 * @generated
	 */
	public Simpleaf3Switch() {
		if (modelPackage == null) {
			modelPackage = Simpleaf3Package.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Simpleaf3Package.BEHAVIOR: {
		...
		case Simpleaf3Package.CODE_SPECIFICATION: {
			CodeSpecification codeSpecification = (CodeSpecification) theEObject;
			T result = caseCodeSpecification(codeSpecification);
			if (result == null)
				result = caseBehavior(codeSpecification);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Code Specification</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Code Specification</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCodeSpecification(CodeSpecification object) {
		return null;
	}
