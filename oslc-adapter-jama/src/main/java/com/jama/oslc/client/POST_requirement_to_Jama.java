...
//		
//		String reqIdentifier = "newRequirementX2001";
...
//
//					String username = "abid@fortiss.org";
//					String password = "Hooriya786_";
//					String jamaInstanceName = "xklzp";
//
//					
//					int projectId = 15;
//
...
//	}
	...
	public void createJamaRequirement() {
		
	String projectIDForJSON = "15";
		
		String reqIdentifier = "newRequirementX2001786";
		// create new requirement
		Requirement requirement = new Requirement();
		requirement.setAbout(URI.create("http://localhost:8080/jama-oslc-adapter/services/Semiconductor_Sample_Set/requirement/" + reqIdentifier));
		requirement.setTitle(reqIdentifier);
		requirement.setIdentifier(reqIdentifier);
		requirement.setDescription(reqIdentifier);
		((Requirement) requirement).setParentID("569");	// this is hard coded
		...
		// Convert requirement into JSON for Jama REST API
					...
					try {
						...
						if(((Requirement) requirement).getParentID() != null){
							parentObject.put("item", Integer.valueOf(((Requirement) requirement).getParentID()));
						}
...
//					String jamaInstanceName = "koneksys";
		...
		System.out.println("called the create Jama Requiremenet");
